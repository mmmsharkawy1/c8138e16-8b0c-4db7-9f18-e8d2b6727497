...
USING (tenant_id = public.get_tenant_id() AND public.get_role() = 'manager')
WITH CHECK (
...
USING (tenant_id = public.get_tenant_id() AND public.get_role() = 'owner')
...
USING (tenant_id = public.get_tenant_id() AND public.get_role() IN ('owner', 'manager', 'cashier'))
WITH CHECK (tenant_id = public.get_tenant_id());
...
WITH CHECK (
    tenant_id = public.get_tenant_id() AND 
    public.get_role() IN ('owner', 'manager', 'cashier')
);
...
WITH CHECK (tenant_id = public.get_tenant_id() AND public.get_role() IN ('owner', 'manager', 'cashier'));
